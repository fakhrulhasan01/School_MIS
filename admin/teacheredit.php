...
if(isset($_POST['sub'])){
   ...
   if($_POST['class']==""){
      $err++;
      $eclass.="Please enter assigning class.";
      }
      else if(strlen($_POST['class'])<3){
	  $err++;
	  $eclass.="Assigning class name must be three character.";
	  }
   ...
   if($_POST['gen']==""){
	...
	if($_POST['mob']==""){
      $err++;
      $emobile.="Please enter student  mobile no.";
      }
...
<h1><center>Teacher Registration</center></h1>
  ...
  <tr>
    <td>Assigning Class</td>
    <td><input type="text" name="class" /></td>
    <td><?php mer($eclass);?></td>
  </tr> 
