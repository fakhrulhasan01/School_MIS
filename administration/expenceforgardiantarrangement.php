...
<center><h5>If you want to check other balence please&nbsp;<a href="?ad=checkBalenceOtherMonthGardian">Click Here</a></h5>
</center>
...
$nov </b></center></td></tr>";
	 ...
	 echo "<tr>";
	 	...
	 	echo "<td><a title='Delete' href='?ad=expenceforgardiantarrangementdelete&id=".$r[$i][0]."'><center><img src='icon-images/delete.jpg'  height='22' width='28'/></center></a></td>";
		echo "<td><a title='Edit' href='?ad=expenceforgardiantarrangementedit&id=".$r[$i][0]."'><center><img src='icon-images/edit.jpg'  height='22' width='28'/></center></a></td>";
